...
*   **Sensitivity Controls (Slicer Pane):** 
    *   **Slippage Threshold:** Adjust the minimum "speed loss *in Delivery Delay*" (0.5 to 3.0 days) required to trigger an alert.
    *   **Statistical Boundary:** Adjust the Standard Deviation multiplier (1.0 to 3.0) to tighten or loosen the detection logic.
*   **Paging Controls:** Navigate large lists of at-risk sellers using the "Page" and "Items per Page" (Inside Filter Pane) selectors.
