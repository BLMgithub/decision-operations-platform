...
* **Referential Orphans:** Orphans are silently dropped and logged under the `removed_ghost_orphan_rows` metric, ensuring downstream joins in the Assembly stage are 100% clean.